...
<body style="background-color: #000;">
    ...
    <header style="background-color: whitesmoke;">
       ...
       <div class="main-menu f-right d-none d-lg-block">
        ...
        //This is the backend code for the measurement
...
//            move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file);
    ...
    //This is the backend code to update a customer
       ...
       $reg_enddate = ($_POST['reg_enddate']);
        ...
        $sql_update = "UPDATE measurement SET name = '$reg_name', shoulder = '$reg_shoulder', chest = '$reg_chest', sslength = '$reg_sslength', lslength = '$reg_lslength', elbow_length = '$reg_elbow_length', round_elbow = '$reg_round_elbow', wrist = '$reg_wrist', arm = '$reg_arm', neck = '$reg_neck', uhip = '$reg_uhip', waist = '$reg_waist', lhip = '$reg_lhip', thigh = '$reg_thigh', crotch = '$reg_crotch', knee_length = '$reg_knee_length', round_knee = '$reg_round_knee', trouser = '$reg_trouser', ankle = '$reg_ankle', enddate = '$reg_enddate', status = 'Pending' WHERE id = '$id'";
    ...
    <center>
        <div style='border: 3px solid #9eeaf6; width: 560px; height: 1300px; border-radius: 25px;
            ...
            <form name="search" action="admin_login.php" method="POST" enctype="multipart/form-data">
                <input  type="text" style="width: 300px;" placeholder="search name here" name="reg_find" id="autocomplete" required="true" maxlength="50">
                <input type="submit" value="SEARCH"  name="reg_search">
       ...
       <input id="textbox_style" type='text' value="<?php echo "$get_ankle";?>" placeholder='Enter name here' name='reg_ankle'  required="true" maxlength="50"/>
        ...
        <input style="border-color: whitesmoke; font-size: 22px; border-radius: 10px; color:black; background-color: #ff9900; color: white;" type="submit" name='reg_update' value="Update">
